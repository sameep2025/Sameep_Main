...
// Modal
function PricingModal({ show, onClose, onSave, initialData }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h3 style={{ marginTop: 0, color: "#00AEEF" }}>
          {initialData ? "Edit Category Pricing Model" : "Add Category Pricing Model"}
        </h3>
...
export default function CategoryPricingPage() {
  ...
  const fetchItems = async () => {
    try {
      ...
      console.error(err);
      alert("Failed to fetch category pricing models");
    }
  };
  ...
  const handleSave = async (data) => {
    try {
      ...
      console.error(err);
      alert("Failed to save category pricing model");
    }
  };
  ...
  &gt; Pricing Model
      ...
      <h2 style={{ color: "#00AEEF" }}>Category Pricing Model</h2>
